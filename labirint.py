...
class Enemy(GameSprite):
 ...
 def update(self):
     if self.rect.x <= 480: #w1.wall_x + w1.wall_width
         self.side = "right"
...
back = (randint(0, 255), randint(0, 255), randint(0, 255))#setting the color according to the RGB color scheme
...
w2 = GameSprite('platform2_v.png', 420, 100, 50, 500)
...
final_sprite = GameSprite('pac-1.png', win_width - 85, win_height - 90, 80, 80)

monster1 = Enemy('cyborg.png', win_width - 80, 150, 80, 80, randint(8, 18))
monster2 = Enemy('cyborg.png', win_width - 80, 300, 80, 80, randint(8, 18))
monster3 = Enemy('cyborg.png', win_width - 80, 450, 80, 80, randint(8, 18))
...
run = True
while run:
    #the loop is triggered every 0.03 seconds
    time.delay(30)
